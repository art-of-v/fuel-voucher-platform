...
export default function CheckoutScreen() {
  ...
  const fixedFooter = cart.length > 0 ? (
    <div className="p-4 bg-black/95 backdrop-blur-md border-t-2 border-primary/30">
      <button
        onClick={async () => {
  ...
  if (!isAuthenticated) {
    return (
      <PageLayout background={background}>
        <div className="p-6 text-white flex flex-col items-center justify-center h-full min-h-[70vh] relative">
  ...
  if (cart.length === 0) {
    return (
      <PageLayout header={header}>
        <div className="p-6 text-white flex flex-col items-center justify-center h-full min-h-[50vh]">
  ...
  return (
    <PageLayout
      ...
      scrollClassName="p-6 space-y-4 pb-32"
    >
      {/* Order items */}
