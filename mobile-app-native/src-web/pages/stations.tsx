...
export default function StationsScreen() {
  ...
  return (
    <div className="p-4 sm:p-6 pt-6 sm:pt-8 space-y-4 sm:space-y-6 relative overflow-hidden">
      ...
      <header className="relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-0 mb-4">
          <div className="flex items-center gap-2 sm:gap-3 text-red-500 font-mono text-[10px] sm:text-xs tracking-widest uppercase bg-red-500/10 border border-red-500/30 px-3 sm:px-4 py-2 rounded">
          ...
          <Link href="/map">
            <button className="flex items-center justify-center gap-2 bg-primary/10 border border-primary/50 text-primary px-3 sm:px-4 py-2 rounded font-mono text-[10px] sm:text-xs tracking-widest uppercase hover:bg-primary hover:text-black transition-all w-full sm:w-auto">
