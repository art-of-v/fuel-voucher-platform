...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'codes.tapToOpen': 'Tap to open QR code',
    ...
    'payment.securedBy': 'Secured by Bank-Grade Encryption • Your payment info is encrypted',
  ...
  uk: {
    ...
    'codes.empty': 'Активів поки немає',
    ...
    'codes.noActiveCodes': 'НЕМАЄ АКТИВНИХ АКТИВІВ',
    ...
    'codes.tapToOpen': 'Натисніть, щоб відкрити QR-код',
    'codes.vaultStorage': 'СХОВИЩЕ АКТИВІВ',
    ...
    'payment.securedBy': 'Захищено банківським шифруванням • Ваші платіжні дані зашифровані',

    // Payment Success
    'paymentSuccess.title': 'ОПЛАТА УСПІШНА!',
    'paymentSuccess.subtitle': 'Ваші паливні набори обробляються',
    'paymentSuccess.sessionId': 'ID сесії',
    'paymentSuccess.confirmed': 'Ваш платіж підтверджено!',
    'paymentSuccess.checkVouchers': 'Перевірте свої набори в розділі "Мої активи". Вони з\'являться протягом кількох хвилин.',
    'paymentSuccess.viewVouchers': 'ПЕРЕГЛЯНУТИ МОЇ АКТИВИ',
  ...
  de: {
    ...
    'payment.securedBy': 'Gesichert durch Banken-Verschlüsselung • Ihre Zahlungsinformationen sind verschlüsselt',
  ...
  es: {
    ...
    'payment.securedBy': 'Protegido por cifrado de grado bancario • Su información de pago está cifrada',
