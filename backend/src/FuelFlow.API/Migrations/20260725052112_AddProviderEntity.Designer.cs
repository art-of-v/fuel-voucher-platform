...
namespace FuelFlow.API.Migrations
{
    ...
    [Migration("20260725052112_AddProviderEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FuelFlow.API.Features.Providers.SharedModels.Provider", b =>
                {
            ...
            modelBuilder.Entity("FuelFlow.API.Features.Providers.SharedModels.Provider", b =>
                {
                    b.OwnsOne("FuelFlow.API.Features.Providers.SharedModels.ProviderConfig", "Config", b1 =>
                        {
                            b1.Property<string>("ProviderId")
                                .HasColumnType("character varying(50)");

                            b1.Property<string>("DefaultColor")
                                .IsRequired()
                                .HasMaxLength(20)
                                .HasColumnType("character varying(20)");

                            b1.PrimitiveCollection<string>("DetectionKeywords")
                                .IsRequired()
                                .HasColumnType("jsonb");

                            b1.PrimitiveCollection<string>("FuelTypePatterns")
                                .IsRequired()
                                .HasColumnType("jsonb");
                            ...
                            b1.Property<Dictionary<string, JsonElement>>("ParsingRules")
                                .IsRequired()
                                .HasColumnType("jsonb");

                            b1.Property<Dictionary<string, JsonElement>>("Settings")
                                .IsRequired()
                                .HasColumnType("jsonb");

                            b1.PrimitiveCollection<string>("StationIds")
                                .IsRequired()
                                .HasColumnType("jsonb");
