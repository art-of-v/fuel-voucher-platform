export const uk: Record<string, string> = {
   ...
   */
  'basket.clearTitle': 'Очистити кошик?',
  'basket.clearMessage': 'Буде видалено всі позиції. Дію не можна скасувати.',
  'basket.clearConfirm': 'ОЧИСТИТИ КОШИК',
  'cart.removeTitle': 'Видалити цю позицію?',
  'cart.removeMessage': 'Її буде вилучено з кошика.',
  'cart.removeConfirm': 'ВИДАЛИТИ',
  'cart.removeLabel': 'Видалити позицію',
  'cart.quantityLabel': 'Кількість',
  'codes.idCopied': 'ID ваучера скопійовано',
  'codes.copyId': 'Скопіювати ID ваучера',
   ...
   */
  'redemption.title': 'ВИКОРИСТАТИ НА АЗС',
  'redemption.subtitle': 'Покажіть цей код сканеру колонки.',
  'redemption.ready': 'ГОТОВИЙ',
  'redemption.expiringSoon': 'СКОРО ЗАКІНЧУЄТЬСЯ',
  'redemption.markAsUsed': 'ПОЗНАЧИТИ ВИКОРИСТАНИМ',
  'redemption.markAsUsedAgain': 'ПОЗНАЧИТИ ВИКОРИСТАНИМ ЗНОВУ',
  'redemption.markAsUsedHint':
    'Підтвердіть після заправки. Касиру це не потрібно — ваш QR вже був авторизований на колонці.',
  'redemption.confirmTitle': 'Позначити актив використаним?',
  'redemption.confirmMessage':
    'Підтверджуйте лише після заправки. Цю дію не можна скасувати з застосунку.',
  'redemption.confirmAction': 'ПОЗНАЧИТИ ВИКОРИСТАНИМ',
  'redemption.markedSuccess': 'Актив позначено використаним',
  'redemption.markFailed': 'Не вдалося позначити актив використаним. Спробуйте ще раз.',
  'redemption.restoredSuccess': 'Актив відновлено',
  'redemption.restoreFailed': 'Не вдалося відновити актив. Спробуйте ще раз.',
  'redemption.redemptionRules': 'Правила використання',
  'redemption.showRules': 'Показати правила',
  'redemption.hideRules': 'Сховати правила',
  'redemption.scanTips':
    'Тримайте телефон рівно на 15–25 см від сканера, при хорошому освітленні. Яскравість підвищується автоматично.',
  'redemption.payloadMissing': 'Не вдається створити QR',
  'redemption.payloadMissingHelp':
    'Відкрийте гаманець, коли буде з’єднання. QR не може бути створено без даних ваучера.',
  'redemption.payloadMissingHint':
    'QR не може бути створено без даних ваучера. Оновіть гаманець.',
  'redemption.expiredMessage':
    'Термін дії цього активу минув, використати його неможливо. Зв’яжіться з підтримкою, якщо вважаєте це помилкою.',
  'redemption.close': 'Закрити',

  'wallet.title': 'Мої активи',
  'wallet.subtitle': 'Натисніть на актив, щоб показати його QR на колонці.',
  'wallet.usableCount': 'Доступно: {0}',
  'wallet.usableCount_one': 'Доступно: {0}',
  'wallet.sectionUsable': 'Готові до використання',
  'wallet.sectionUsed': 'Використані',
  'wallet.sectionExpired': 'Прострочені',
  'wallet.sectionOther': 'Інші',
  'wallet.emptyTitle': 'Активів поки немає',
  'wallet.emptyDescription': 'Придбайте паливний пакет на будь-якій станції, щоб отримати актив.',
  'wallet.offline': 'Ви офлайн. Активи можуть бути неактуальними.',
  'wallet.errorTitle': 'Не вдалося завантажити активи',
  'wallet.errorDescription': 'Перевірте з’єднання та спробуйте ще раз.',
  'wallet.refresh': 'Оновити',

  'contracts.signAction': 'ПІДПИСАТИ',
  'company.invitations.declineTitle': 'Відхилити запрошення?',
  'company.invitations.declineMessage':
    'Його буде видалено остаточно. Щоб долучитися до компанії, знадобиться нове запрошення.',
  'stations.viewPackages': 'Переглянути пакети',
};
