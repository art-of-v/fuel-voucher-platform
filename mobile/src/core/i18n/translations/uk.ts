export const uk: Record<string, string> = {
  ...
  'profile.changeEmailInvalidCode': 'Недійсний або застарілий код',
  'profile.changeEmailRateLimited': 'Забагато спроб. Зачекайте хвилину та спробуйте знову.',
  'profile.changeEmailInvalidFormat': 'Введіть дійсну електронну пошту',
  'profile.changeEmailSameEmail': 'Це вже ваша адреса пошти',
  ...
  'phoneAuth.consentPrefix': 'Я погоджуюсь з',
  'phoneAuth.consentLink': 'Політикою конфіденційності',
