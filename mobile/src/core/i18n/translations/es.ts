export const es: Record<string, string> = {
  ...
  'profile.edit': 'Editar',
  'profile.editPersonalTitle': 'Información personal',
  'profile.editCompanyTitle': 'Información de la empresa',
  'profile.activitySection': 'ACTIVIDAD',
  'profile.settingsSection': 'CONFIGURACIÓN',
  ...
  'profile.companyAddress': 'DOMICILIO SOCIAL',
  ...
  'profile.changeEmailInvalidCode': 'Código no válido o caducado',
  'profile.changeEmailRateLimited': 'Demasiados intentos. Espera un minuto e inténtalo de nuevo.',
  'profile.changeEmailInvalidFormat': 'Introduce un correo electrónico válido',
  'profile.changeEmailSameEmail': 'Ese ya es tu correo electrónico',
  ...
  'phoneAuth.consentPrefix': 'Acepto la',
  'phoneAuth.consentLink': 'Política de privacidad',
