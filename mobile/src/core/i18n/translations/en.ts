export const en: Record<string, string> = {
  ...
  'profile.changeEmailResend': 'Resend code',
  'profile.changeEmailBack': 'Change email address',
  'profile.changeEmailInvalidCode': 'Invalid or expired code',
  'profile.changeEmailRateLimited': 'Too many attempts. Please wait a minute and try again.',
  'profile.changeEmailInvalidFormat': 'Enter a valid email address',
  'profile.changeEmailSameEmail': 'This is already your email address',
  ...
  'notifications.emptyHint': 'Updates about your orders will appear here.',
