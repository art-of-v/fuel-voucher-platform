...
import { Archive, BarChart, Building, Fuel, Package, ShoppingCart, Users, QrCode, Menu, Ticket, X, FileSignature, FileCheck, BadgeDollarSign, BarChart3 } from "lucide-react";
