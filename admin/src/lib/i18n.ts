...
const translations: Record<Language, Record<string, string>> = {
    ...
    uk: {
        ...
        'reconciliation.paymentDesc': 'Придбання ваучерів: {0} {1}L x{2}',
        'reconciliation.redemptionDesc': 'Використання ваучера: {0} {1}L',
        'reconciliation.total': 'Всього:',
        'reconciliation.summaryInfo': 'Зведена інформація:',
        'reconciliation.totalOrders': 'Всього замовлень: {0}',
        'reconciliation.vouchersPurchased': 'Придбано ваучерів: {0} шт. ({1} л)',
        'reconciliation.vouchersUsed': 'Використано ваучерів: {0} шт. ({1} л)',
