...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'providers.fuelNominalsHint': 'Click to set liter denominations for this fuel only; empty the provider default stays.',
  ...
  'providers.fuelNominalsHint': 'Натисніть, щоб задати номінали в літрах лише для цього пального; інакше діє значення провайдера за замовчуванням.',
  ...
  'providers.discount': 'Rabatt',
   ...
   'providers.fuelNominalsHint': 'Klicken, um Liter-Denominationen nur für diesen Kraftstoff festzulegen; sonst bleibt der Anbieter-Standard.',
  ...
  'providers.discount': 'Descuento',
   ...
   'providers.fuelNominalsHint': 'Haz clic para fijar denominaciones en litros solo para este combustible; de lo contrario, se mantiene el valor predeterminado del proveedor.',
